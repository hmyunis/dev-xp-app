...
import { AuthTokens, ApiResponse, PaginatedResponse, User, StudentProfile, StoreItem, Transaction } from '@/types';
...
export const studentApi = {
  getLeaderboard: (params?: { page?: number; pageSize?: number }) =>
    apiClient.get<ApiResponse<PaginatedResponse<StudentProfile>>>('/students/leaderboard/', { params }),
  
  getStudentProfiles: (params?: { page?: number; pageSize?: number; search?: string }) =>
    apiClient.get<ApiResponse<PaginatedResponse<StudentProfile>>>('/students/profiles/', { params }),
...
export const storeApi = {
  ...
  getStoreItem: (id: number) =>
    apiClient.get<ApiResponse<StoreItem>>(`/store/items/${id}/`),
  ...
  deleteStoreItem: (id: number) =>
    apiClient.delete(`/store/items/${id}/`),
  
  getTransactions: (params?: { page?: number; pageSize?: number; studentId?: number; itemId?: number }) =>
    apiClient.get<ApiResponse<PaginatedResponse<Transaction>>>('/store/transactions/', { params }),
