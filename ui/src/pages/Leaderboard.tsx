            ...
            {students.length >= 3 && (
                <motion.div variants={itemVariants}>
                    <Card className="bg-gradient-to-r from-purple-100 to-pink-100 border-2 border-purple-200">
                        ...
                        <CardContent>
                            <div className="flex flex-col sm:flex-row justify-center items-end sm:space-x-4 space-y-4 sm:space-y-0">
                                {/* 2nd Place */}
                                <motion.div whileHover={{ scale: 1.05 }} className="text-center">
                                    ...
                                    <div className="bg-white rounded-lg p-4 shadow-md min-w-[120px]">
                                        ...
                                        <div className="font-semibold text-gray-800">
                                            {students[1].user.fullName}
                                        </div>
                                        <div className="text-sm text-gray-600">
                                            {students[1].totalXp} XP
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} className="text-center">
                                    ...
                                    <div className="bg-white rounded-lg p-4 shadow-lg min-w-[140px] border-2 border-yellow-400">
                                        ...
                                        <div className="font-semibold text-gray-800">
                                            {students[0].user.fullName}
                                        </div>
                                        <div className="text-sm text-gray-600">
                                            {students[0].totalXp} XP
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} className="text-center">
                                    ...
                                    <div className="bg-white rounded-lg p-4 shadow-md min-w-[120px]">
                                        ...
                                        <div className="font-semibold text-gray-800">
                                            {students[2].user.fullName}
                                        </div>
                                        <div className="text-sm text-gray-600">
                                            {students[2].totalXp} XP
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
                        ...
                        <div className="space-y-3">
                            {students.map((student, index) => (
                                <motion.div
                                    ...
                                    className="flex flex-col sm:flex-row items-center gap-4 p-4 bg-white rounded-lg shadow-md border-2 border-transparent hover:border-indigo-300 transition-all"
                                >
                                    <div
                                    ...
                                    <div className="flex-1 w-full">
                                        <div className="flex flex-col sm:flex-row items-center gap-2">
                                            <h3 className="font-semibold text-gray-800 text-lg text-center sm:text-left">
                                    ...
                                    <div className="text-right w-full sm:w-auto flex flex-col items-center sm:items-end">
                                        <Badge
