...
export function BulkXpDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Grant XP to {selectedCount} students</DialogTitle>
                </DialogHeader>
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <DialogFooter>
                        ...
                        <Button type="submit" disabled={loading || !xpPoints || !xpReason}>
                            {loading ? "Granting..." : "Grant XP"}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
